...
def generate_inference_question():
    ...
    # 设置系统消息来生成推理性问题
    system_message = ("You are an expert in materials science. Based on the provided `<text>`, identify exactly one piece of scientifically valuable information, such as specific data, chemical substances, material compositions, or other directly relevant scientific information. "
        ...
        "- Inferring a material's specific composition or identifying a substance "
        ...
        "The answer must be highly specific and suitable for F1 evaluation, such as a material name, a specific numeric value, or a clear 'yes' or 'no.' "
...
system_message = ("You are a materials science expert. Please answer the question based strictly on the provided context, using reasoning as needed to give a precise response. "
