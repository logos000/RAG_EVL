...
def extract_useful_information(content):
    system_message = (
        ...
        "in the field of materials science. Additionally, determine if the answer to a potential retrieval question "
...
def generate_inference_question():
    ...
    # 设置系统消息来生成信息验证问题
    system_message = (
        "You are an expert in materials science. Based on the provided `<text>`, identify a specific fact or claim that could benefit from verification, "
        "such as experimental data, references, chemical substances, material compositions, or any other directly relevant scientific information. "
        ...
        "- Verifying or challenging the use of a particular chemical substance or material"
        ...
        "{"
        "  \"question\": \"Is MoS₂ definitely the most effective catalyst in this experiment, compared to other potential materials?\""
        "}"
...
system_message = (
    "You are a materials science expert. Based on the question and the provided context, answer the question directly with either 'yes' or 'no,' depending on whether the context supports the claim. "
    ...
    "Provide only 'yes' or 'no' as your answer, without any additional explanations or statements."
)
