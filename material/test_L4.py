...
def generate_inference_question():
    ...
    # 设置系统消息来生成信息补全问题
    system_message = (
        "You are an expert in materials science. Based on the provided `<text>`, identify any missing or incomplete scientific information needed to complete the content, "
        "such as specific experimental data, references, chemical substances, material compositions, or other directly relevant details. "
        ...
        "- Adding missing chemical substances or material compositions "
...
system_message = (
    "You are a materials science expert. Based on the question and the provided context, fill in the missing or incomplete scientific information needed to make the content whole. "
