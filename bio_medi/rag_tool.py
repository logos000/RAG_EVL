...
from langchain_community.document_loaders import Docx2txtLoader, CSVLoader,TextLoader, UnstructuredHTMLLoader 
...
class ragTool(object):
    ...
    def __init__(self):
        self.loader = {
            ...
            ".docx": Docx2txtLoader,
            ".csv": CSVLoader,
            ".html": UnstructuredHTMLLoader,  # 添加 HTML 加载器
    ...
    def get_file(self, filename):
        ...
        if file_type in self.loader:
            loader_class_or_func = self.loader[file_type]
            if callable(loader_class_or_func):
                loader = loader_class_or_func(filename)
            else:
                loader = loader_class_or_func(filename)
            return loader.load()
        else:
    ...
    def vector_storage(self, filename):
        ...
        # 定义集合名称
        collection_name = "biomedicine_collection"
