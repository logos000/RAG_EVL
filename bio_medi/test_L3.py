...
#         "in the field of biomedicines science. Additionally, determine if the answer to a potential retrieval question "
...
def generate_inference_question():
    ...
    # 设置系统消息来生成推理性问题
    system_message = ("You are an expert in biomedicines science. Based on the provided `<text>`, identify exactly one piece of scientifically valuable information, such as specific data, chemical substances, biomedicine compositions, or other directly relevant scientific information. "
        ...
        "- Inferring a biomedicine's specific composition or identifying a substance "
        ...
        "The answer must be highly specific and suitable for F1 evaluation, such as a biomedicine name, a specific numeric value, or a clear 'yes' or 'no.' "
...
# result = rag_tool.vector_storage("E:\AAProgramming\AAmy\RAG_EVL\medical\data.csv")
...
system_message = ("You are a biomedicines science expert. Please answer the question based strictly on the provided context, using reasoning as needed to give a precise response. "
