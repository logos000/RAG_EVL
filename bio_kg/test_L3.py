...
def generate_inference_question():
    ...
    all_content = rag_tool.random_retrieve_milvus("medical_collection", )  # 调用检索函数，不指定查询关键词
    #print(all_content)
    #if (not all_content) :
    ...
    # 设置系统消息来生成推理性问题
    system_message = ("You are an expert in biologys science. Based on the provided `<text>`, identify exactly one piece of scientifically valuable information, such as specific data, chemical substances, biology compositions, or other directly relevant scientific information. "
...
system_message = ("You are a biologys science expert. Please answer the question based strictly on the provided context, using reasoning as needed to give a precise response. "
