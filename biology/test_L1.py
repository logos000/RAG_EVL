...
def generate_question(content):
    system_message = (
        "You are an expert in information retrieval in the field of biology science. "
...
# 读取文件夹中的所有HTML文件
folder_path = r"E:\AAProgramming\AAmy\RAG_EVL\biology\html_1"  # 替换为你的HTML文件夹路径
...
for filename in os.listdir(folder_path):
    ...
    if os.path.isfile(file_path) and filename.lower().endswith('.html'):  # 确保是html文件
