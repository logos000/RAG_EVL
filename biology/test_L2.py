...
#         "in the field of biology science. Additionally, determine if the answer to a potential retrieval query "
...
def generate_question(content):
    system_message = (
        "You are an expert in biology science. "
        "Based on the provided <text>, identify exactly one piece of valuable information "
        "such as data, tables, chemical substances, biology compositions, or other scientific information, "
        "excluding information about the author or the article itself. "
...
# 读取文件夹中的所有MMD文件
folder_path = r"E:\AAProgramming\AAmy\RAG_EVL\biology\html_2"  # 替换为你的文件夹路径
...
for filename in os.listdir(folder_path):
    ...
    if os.path.isfile(file_path) and filename.lower().endswith('.html'):  # 确保是txt文件
